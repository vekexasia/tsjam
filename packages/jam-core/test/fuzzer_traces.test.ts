...
describe.skipIf(getConstantsMode() == "full")("fuzzer_traces", () => {
  ...
  it("1763487844", () => doTest("1763487844"));
  it("1763487888", () => doTest("1763487888"));
  it("1763487981", () => doTest("1763487981"));
  it("1763487989", () => doTest("1763487989"));
  it("1763488067", () => doTest("1763488067"));
  it("1763488081", () => doTest("1763488081"));
  it("1763488162", () => doTest("1763488162"));
  it("1763488212", () => doTest("1763488212"));
  it("1763488259", () => doTest("1763488259"));
  it("1763488328", () => doTest("1763488328"));
  it("1763488465", () => doTest("1763488465"));
  it("1763489287", () => doTest("1763489287"));
  it("1763489605", () => doTest("1763489605"));
  it("1763489659", () => doTest("1763489659"));
  it("1763489715", () => doTest("1763489715"));
  it("1763489748", () => doTest("1763489748"));

  it("1763489798", () => doTest("1763489798"));
});
@JamCodecable()
