...
export const etToIdentifiers = (
  ...
  // $(0.5.4 - 6.29) | we validate the ticket
  ...
  // $(0.5.4 - 6.32) | tickets should be in order and unique
  ...
  // $(0.5.4 - 6.33) | make sure ticket were not submitted already
