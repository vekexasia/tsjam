...
export const buildAliases = (import_meta_url: string) => {
  return {
    ...
    "@tsjam/transitions": new URL("../jam-transitions/", import_meta_url)
      .pathname,
    "@tsjam/crypto": new URL("../jam-crypto/", import_meta_url).pathname,
    "@tsjam/crypto-napi": new URL("../jam-crypto-napi/", import_meta_url)
      .pathname,
    "@tsjam/merklization": new URL("../jam-merklization/", import_meta_url)
      .pathname,
    "@tsjam/testnet": new URL("../jam-testnet/", import_meta_url).pathname,
  };
};
